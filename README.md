<img src="./.assets/christmas_ferris.png" width="164" alt="Christmas Crab">
...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `15.8µs` | `18.0µs` |
| [Day 2](./src/bin/02.rs) | `2.1µs` | `6.8µs` |
| [Day 3](./src/bin/03.rs) | `9.5µs` | `29.5µs` |
| [Day 4](./src/bin/04.rs) | `44.6µs` | `384.3µs` |
| [Day 5](./src/bin/05.rs) | `34.2µs` | `9.8µs` |
| [Day 6](./src/bin/06.rs) | `33.0µs` | `22.6µs` |
| [Day 7](./src/bin/07.rs) | `26.3µs` | `56.6µs` |
| [Day 8](./src/bin/08.rs) | `16.8ms` | `17.0ms` |
| [Day 9](./src/bin/09.rs) | `87.7µs` | `14.0ms` |
| [Day 10](./src/bin/10.rs) | `410.0µs` | `11.0ms` |
| [Day 11](./src/bin/11.rs) | `106.7µs` | `265.6µs` |
| [Day 12](./src/bin/12.rs) | `25.5µs` | `-` |
